...
* Build : ```-project (or -workspace) project_path/project_name -scheme build_scheme -sdk iphonesimulator -configuration Debug ONLY_ACTIVE_ARCH=NO build``` (project_name: the .xcodeproj file at project_path)
* Test : ```test```
